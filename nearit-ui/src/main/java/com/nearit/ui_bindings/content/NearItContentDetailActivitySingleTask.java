...
public class NearItContentDetailActivitySingleTask extends BaseContentDetailActivity {
    ...
    public static Intent createIntent(Context context, @Nullable TrackingInfo trackingInfo, Content content, ContentDetailExtraParams params) {
        Intent intent = new Intent(context, NearItContentDetailActivitySingleTask.class);
